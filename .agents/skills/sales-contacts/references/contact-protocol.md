...
Use `read_url_content` to fetch these pages (skip any already provided in the discovery briefing):
...
Use `search_web` to find key stakeholders on LinkedIn. Execute these searches:
