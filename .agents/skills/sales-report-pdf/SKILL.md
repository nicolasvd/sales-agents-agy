...
description: >-
  Visual PDF sales pipeline report generator. Transforms sales pipeline data and prospect metrics into multi-page PDF documents with score gauges, charts, and executive summaries using ReportLab.
---
