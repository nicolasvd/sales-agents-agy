...
Write the full output to `reports/{slug}/markdown/COMPANY-RESEARCH.md`:
...
*Generated by AI Sales Team — Company Research Engine*
```
...
- If `reports/{slug}/markdown/PROSPECT-ANALYSIS.md` exists, reference overall prospect context
- If `reports/{slug}/markdown/DECISION-MAKERS.md` exists, cross-reference leadership findings
- If `reports/{slug}/markdown/COMPETITIVE-INTEL.md` exists, incorporate competitive context
- Suggest follow-up: `contacts <url>` for decision maker deep dive, `qualify <url>` for opportunity assessment
